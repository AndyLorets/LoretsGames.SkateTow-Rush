...
public class CameraManager : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        GameManager.onLose += OnFinish; 
        ScoreManager.onAddScore += PostEffectTweening; 
    }
    ...
    private void PostEffectTweening(int addScore, Vector3 pos)
    {
        if (addScore < 50) return; 
    ...
    private void OnFinish() => ChangeCam(cam_wait_name);
...
public class CameraPostEffect
{
    ...
    private Vignette _vignette = new Vignette();
    private Bloom _bloom = new Bloom();
    private ColorGrading _colorGrading = new ColorGrading();
